...
// every time you press the button it sends you an array 
...
function isValidWalk(walk) {
    ...
    walk.forEach(element => {
        if(element === 'n') vertical ++
        else if(element === 's') vertical --
        else if(element === 'e') horizontal ++
        else if(element === 'w') horizontal --
    })
